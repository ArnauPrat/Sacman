...
namespace dali {
	...
	void Effect::Load( const char* filename ) {
		...
		VertexShader* vertexShader = dali::vertexShaderLoader.Load(vertexShaderName.c_str());
		PixelShader* pixelShader = dali::pixelShaderLoader.Load(pixelShaderName.c_str());
